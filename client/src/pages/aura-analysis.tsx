                                          ...
                                          <p className="text-xs text-gray-600 leading-relaxed">
                                            {(() => {
                                              const meanings: Record<string, string> = {
                                                ...
                                                'Indigo': 'Strong intuitive abilities, psychic insight, deep inner knowing and truth-seeking. Overwhelmed by inner visions, escapism, fear of trusting intuition or self-doubt. Trusting psychic abilities and grounding insights.',
