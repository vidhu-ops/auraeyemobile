...
export default function AuraAnalysis() {
  ...
  const getColorNegativeMeaning = (colorName: string): string => {
    ...
    const additionalNegativeMeanings: Record<string, string> = {
      ...
      'Coral': 'Overwhelming emotions, codependent creativity, exhausting social energy, burnout from giving',
      'Mint': 'Superficial healing, avoiding deep work, spiritual impatience, bypassing necessary integration',
      'Peach': 'Emotional dependency, excessive nurturing, self-neglect through caring, boundary dissolution',
      'Sky Blue': 'Communication overwhelm, truth without wisdom, scattered expression, mental instability',
      'Rose': 'Romantic delusion, love addiction, idealistic expectations, heart manipulation',
      'Amber': 'Living in past, resistance to change, spiritual stagnation, ancestral burden',
      'Gray': 'Emotional numbness, spiritual detachment, avoidance of life, depression tendencies',
      'Black': 'Shadow obsession, negative absorption, depression depths, isolation patterns',
      'Brown': 'Material attachment, earthly limitation, spiritual heaviness, grounding excess',
      'Cyan': 'Emotional coldness, communication detachment, truth without heart, analytical overwhelm'
    };
