                                  ...
                                  <div className="bg-white rounded-lg p-4 border border-pink-200">
                                    ...
                                    <div className="text-center mb-3">
                                      <div className="text-2xl font-bold text-pink-600">
                                        {(() => {
                                          const score = Math.round((0.4 * (result.chakraActivity?.heart || 5)) + (0.3 * (result.chakraActivity?.sacral || 5)) + (0.3 * (result.chakraActivity?.throat || 5)));
                                          return score;
                                        })()}/10
                                      </div>
                                    ...
                                    <div className="text-center mb-3">
                                      <div className="text-2xl font-bold text-green-600">
                                        {(() => {
                                          ...
                                          const score = Math.round((0.3 * (result.chakraActivity?.root || 5)) + (0.3 * (result.chakraActivity?.solarPlexus || 5)) + (0.4 * earthStarScore));
                                          return score;
                                        })()}/10
                                      </div>
                                  ...
                                  <div className="bg-white rounded-lg p-4 border border-blue-200">
                                    ...
                                    <div className="text-center mb-3">
                                      <div className="text-2xl font-bold text-blue-600">
                                        {(() => {
                                          const score = Math.round((0.4 * (result.chakraActivity?.solarPlexus || 5)) + (0.3 * (result.chakraActivity?.thirdEye || 5)) + (0.3 * (result.chakraActivity?.crown || 5)));
                                          return score;
                                        })()}/10
                                      </div>
                                  ...
                                  <div className="bg-white rounded-lg p-4 border border-purple-200">
                                    ...
                                    <div className="text-center mb-3">
                                      <div className="text-2xl font-bold text-purple-600">
                                        {(() => {
                                          const score = Math.round((0.4 * (result.chakraActivity?.sacral || 5)) + (0.3 * (result.chakraActivity?.heart || 5)) + (0.3 * (result.chakraActivity?.root || 5)));
                                          return score;
                                        })()}/10
                                      </div>
                                    ...
                                    <div className="text-center mb-3">
                                      <div className="text-2xl font-bold text-indigo-600">
                                        {(() => {
                                          ...
                                          const score = Math.round((0.4 * (result.chakraActivity?.crown || 5)) + (0.3 * (result.chakraActivity?.thirdEye || 5)) + (0.3 * soulStarScore));
                                          return score;
                                        })()}/10
                                      </div>
                                  ...
                                  <div className="bg-white rounded-lg p-4 border border-orange-200">
                                    ...
                                    <div className="text-center mb-3">
                                      <div className="text-2xl font-bold text-orange-600">
                                        {(() => {
                                          const score = Math.round((0.4 * (result.chakraActivity?.root || 5)) + (0.3 * (result.chakraActivity?.solarPlexus || 5)) + (0.3 * (result.chakraActivity?.sacral || 5)));
                                          return score;
                                        })()}/10
                                      </div>
                                  ...
                                  <div className="bg-white rounded-lg p-4 border border-yellow-200">
                                    ...
                                    <div className="text-center mb-3">
                                      <div className="text-2xl font-bold text-yellow-600">
                                        {(() => {
                                          const score = Math.round((0.4 * (result.chakraActivity?.solarPlexus || 5)) + (0.3 * (result.chakraActivity?.root || 5)) + (0.2 * (result.chakraActivity?.thirdEye || 5)) + (0.1 * (result.chakraActivity?.sacral || 5)));
                                          return score;
                                        })()}/10
                                      </div>
                                  ...
                                  <div className="bg-white rounded-lg p-4 border border-gray-300">
                                    ...
                                    <div className="text-center mb-3">
                                      <div className="text-2xl font-bold text-gray-600">
                                        {(() => {
                                          const soulStarScore = Math.round(calculateSoulStarChakra(result)/10);
                                          const score = Math.round((0.4 * (result.chakraActivity?.root || 5)) + (0.3 * soulStarScore) + (0.2 * (result.chakraActivity?.solarPlexus || 5)) + (0.1 * (result.chakraActivity?.thirdEye || 5)));
                                          return score;
                                        })()}/10
                                      </div>
                                  ...
                                  <div className="bg-white rounded-lg p-4 border border-red-300">
                                    ...
                                    <div className="text-center mb-3">
                                      <div className="text-2xl font-bold text-red-600">
                                        {(() => {
                                          const negativeScore = Math.round(100 - (0.3 * (result.chakraActivity?.root || 5) + 0.3 * (result.chakraActivity?.sacral || 5) + 0.2 * (result.chakraActivity?.solarPlexus || 5) + 0.2 * (result.chakraActivity?.thirdEye || 5)) * 10);
                                          return Math.max(0, Math.min(100, negativeScore));
                                        })()}%
                                      </div>
