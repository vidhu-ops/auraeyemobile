...
export default function AuraAnalysis() {
  ...
  const getColorMeaning = (colorName: string): string => {
    const meaningMap: Record<string, string> = {
      'Red': 'Root chakra energy - survival instinct, life force, physical vitality, grounding',
      'Orange': 'Sacral chakra energy - creativity, sexuality, emotional flow, artistic expression',
      'Yellow': 'Solar plexus chakra - personal power, confidence, willpower, mental clarity',
      'Green': 'Heart chakra - unconditional love, healing abilities, compassion, emotional balance',
      'Blue': 'Throat chakra - communication, truth speaking, self-expression, authentic voice',
      'Indigo': 'Third eye chakra - psychic abilities, intuition, inner wisdom, spiritual sight',
      'Violet': 'Crown chakra - spiritual connection, divine consciousness, enlightenment, mysticism',
      'Purple': 'Higher crown chakra - spiritual mastery, mystical awareness, divine wisdom',
      'Pink': 'Higher heart chakra - unconditional love, divine compassion, soul connection',
      'Gold': 'Christ consciousness - divine wisdom, spiritual illumination, soul purpose',
      'Silver': 'Lunar energy - intuitive wisdom, feminine power, psychic protection',
      'Turquoise': 'Higher throat chakra - healing communication, divine truth, soul expression',
      'White': 'Pure divine light - spiritual protection, angelic connection, soul purification',
      'Lavender': 'Spiritual peace - gentle awakening, cosmic consciousness, divine grace',
      'Coral': 'Creative heart energy - artistic expression, gentle passion, emotional creativity',
      'Mint': 'Healing heart energy - renewal power, fresh growth, emotional cleansing',
      'Peach': 'Nurturing heart energy - gentle love, emotional healing, caring vibration',
      'Sky Blue': 'Higher communication - cosmic truth, unlimited expression, divine clarity',
      'Rose': 'Divine love frequency - soul mate connection, spiritual romance, heart healing',
      'Amber': 'Ancient earth wisdom - protection energy, grounding force, timeless knowledge',
      'Gray': 'Neutral wisdom - spiritual balance, detachment, cosmic neutrality',
      'Black': 'Shadow integration - transformation power, protection energy, deep inner work',
      'Crimson': 'Life force power - intense vitality, warrior energy, passionate purpose',
      'Magenta': 'Soul rebellion - unique spiritual path, divine independence, cosmic uniqueness',
      'Brown': 'Earth connection - material stability, practical wisdom, physical grounding',
      'Beige': 'Gentle grounding - peaceful stability, calm presence, neutral harmony',
      'Cyan': 'Emotional clarity - clear feeling expression, healing communication, pure emotion',
      'Lime': 'Fresh life force - new growth energy, vibrant renewal, spring awakening',
      'Maroon': 'Deep earth power - sustained passion, grounded intensity, mature strength',
      'Navy': 'Deep spiritual wisdom - profound intuition, cosmic knowledge, soul depth',
      'Olive': 'Natural harmony - earth wisdom, practical spirituality, balanced growth',
      'Teal': 'Heart-throat bridge - healing words, emotional truth, compassionate communication',
      'Bronze': 'Ancient strength - enduring wisdom, protective power, timeless stability',
      'Cobalt': 'Deep cosmic wisdom - profound spiritual insight, mystical knowledge, universal truth',
      'Emerald': 'Pure heart healing - deep compassion, abundant love, soul growth energy',
      'Jade': 'Balanced heart wisdom - harmonious love, peaceful healing, soul balance',
