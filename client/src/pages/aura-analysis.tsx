...
export default function AuraAnalysis() {
  ...
  const downloadComprehensiveAuraPDF = async () => {
    ...
    try {
      ...
      // Download the PDF and save it to downloads archive if healer
        ...
        try {
          ...
          if (archiveResponse.ok) {
            ...
            toast({
              ...
              description: "Your comprehensive aura analysis report has been downloaded. Archive save failed - check Downloads tab.",
            });
          }
        } catch (archiveError) {
      ...
      // Also trigger regular download for healers
      if (isHealer) {
        pdf.save(fileName);
      }
    } catch (error) {
