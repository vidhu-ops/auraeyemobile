...
export default function AuraAnalysis() {
  ...
  const drawChakraBarGraphPDF = (pdf: any, chakras: any[], startY: number, pageWidth: number, pageHeight: number): number => {
    try {
      ...
      const barStartX = containerPaddingX + 45;
      const barMaxWidth = containerWidth - 45 - 15;
      const barHeight = 6;
      const rowHeight = 10;
      ...
      chakras.forEach((chakra) => {
        ...
        pdf.text(chakra.name, containerPaddingX + 2, yPos + 4.5);
      ...
      console.error('Error drawing chakra bar graph:', error);
      return startY + 20; // Return with minimal offset if error occurs
    }
  };
  ...
  const downloadComprehensiveAuraPDF = async () => {
    ...
    try {
      ...
      // IMPORTANT: ADD DISCLAIMER PAGE AFTER COVER
      ...
      pdf.setFontSize(16);
      pdf.setTextColor(75, 0, 130);
      yPosition = addTextWithPageBreak('A Note from AuraEye™', pageWidth/2, yPosition, { align: 'center' });
      yPosition += 15;

      pdf.setFontSize(11);
      pdf.setTextColor(60, 60, 60);
      
      const disclaimerText = `Dear ${nameToUse},

This personalized AuraEye™ report has been thoughtfully prepared for you by your Licensed Healer, ${user?.username || 'Your Healer'}. Anytime you wish to connect with them you can reach out on their contact information provided separately.

This report reflects the current state of your energetic field — a living snapshot of your emotions, thoughts, and vibrational balance in this moment.

Please remember: this report is not a medical or psychological diagnosis. Instead, it is a tool for self-awareness, empowerment, and energetic guidance — designed to help you understand where your energy flows freely and where it seeks harmony.

Your aura changes—just like your ECG, EEG, or pulse rate—because it reflects your living energy in real time. That's precisely what makes it reliable and empowering: it shows your current state and reminds you that your energy, like your health, can be improved and transformed with awareness.

Use these insights & the guidance of your healer to support your healing journey, strengthen your intuition, and make conscious choices that align your body, mind, and soul.

With light and awareness,
Team AuraEye™
"Your Energy, Made Visible."`;

      yPosition = addWrappedText(disclaimerText, 20, yPosition, pageWidth - 40, 6);
      yPosition += 20;
      ...
      // Start new page for analysis content
      pdf.addPage();
      yPosition = 20;
      ...
      try {
        ...
        if (result?.id && user?.id) {
          try {
            await apiRequest('POST', '/api/save-aura-pdf', {
              auraReadingId: result.id,
              fileName,
              pdfData,
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-dark to-primary-dark text-white py-10">
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <p className="text-wite/80 max-w-2xl mx-auto text-center">
              Upload your photo and our advanced analysis will reveal your energy field, showing your aura colors and providing personalized insights.
            </p>
          </div>
        </section>
                                ...
                                <div className="bg-gradient-to-r from-violet-50 to-purple-50 rounded-lg p-4 border border-violet-200">
                                  <div className="mb-2">
                                    ...
                                    <div className="flex justify-between text-sm mb-1">
                                      ...
                                      <span className="text-violet-600">{result.chakraActivity?.crown || 5}/10 ({(result.chakraActivity?.crown || 5) * 10}%) - {getChakraStatus(result.chakraActivity?.crown || 5)}</span>
                                    </div>
                                  </div>
                                ...
                                <div className="bg-gradient-to-r from-indigo-50 to-blue-50 rounded-lg p-4 border border-indigo-200">
                                  <div className="mb-2">
                                    ...
                                    <div className="flex justify-between text-sm mb-1">
                                      ...
                                      <span className="text-indigo-600">{result.chakraActivity?.thirdEye || 5}/10 ({(result.chakraActivity?.thirdEye || 5) * 10}%) - {getChakraStatus(result.chakraActivity?.thirdEye || 5)}</span>
                                    </div>
                                  </div>
                                ...
                                <div className="bg-gradient-to-r from-blue-50 to-sky-50 rounded-lg p-4 border border-blue-200">
                                  <div className="mb-2">
                                    ...
                                    <div className="flex justify-between text-sm mb-1">
                                      ...
                                      <span className="text-blue-600">{result.chakraActivity?.throat || 5}/10 ({(result.chakraActivity?.throat || 5) * 10}%) - {getChakraStatus(result.chakraActivity?.throat || 5)}</span>
                                    </div>
                                  </div>
                                ...
                                <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg p-4 border border-green-200">
                                  <div className="mb-2">
                                    ...
                                    <div className="flex justify-between text-sm mb-1">
                                      ...
                                      <span className="text-green-600">{result.chakraActivity?.heart || 5}/10 ({(result.chakraActivity?.heart || 5) * 10}%) - {getChakraStatus(result.chakraActivity?.heart || 5)}</span>
                                    </div>
                                  </div>
                                ...
                                <div className="bg-gradient-to-r from-yellow-50 to-amber-50 rounded-lg p-4 border border-yellow-200">
                                  <div className="mb-2">
                                    ...
                                    <div className="flex justify-between text-sm mb-1">
                                      ...
                                      <span className="text-yellow-600">{result.chakraActivity?.solarPlexus || 5}/10 ({(result.chakraActivity?.solarPlexus || 5) * 10}%) - {getChakraStatus(result.chakraActivity?.solarPlexus || 5)}</span>
                                    </div>
                                  </div>
                                ...
                                <div className="bg-gradient-to-r from-orange-50 to-red-50 rounded-lg p-4 border border-orange-200">
                                  <div className="mb-2">
                                    ...
                                    <div className="flex justify-between text-sm mb-1">
                                      ...
                                      <span className="text-orange-600">{result.chakraActivity?.sacral || 5}/10 ({(result.chakraActivity?.sacral || 5) * 10}%) - {getChakraStatus(result.chakraActivity?.sacral || 5)}</span>
                                    </div>
                                  </div>
                                ...
                                <div className="bg-gradient-to-r from-red-50 to-pink-50 rounded-lg p-4 border border-red-200">
                                  <div className="mb-2">
                                    ...
                                    <div className="flex justify-between text-sm mb-1">
                                      ...
                                      <span className="text-red-600">{result.chakraActivity?.root || 5}/10 ({(result.chakraActivity?.root || 5) * 10}%) - {getChakraStatus(result.chakraActivity?.root || 5)}</span>
                                    </div>
                                  </div>
                                  ...
                                  <div className="bg-white rounded-lg p-5 border border-violet-200">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                                      ...
                                      <div className="bg-gradient-to-br from-purple-50 to-purple-50 rounded-lg p-4 border border-purple-200">
                                        ...
                                        <div className="mt-3 flex justify-center">
                                          <div className="px-3 py-1 bg-purple-100 rounded-full">
                                            <span className="text-xs font-medium text-purple-700">. als Overdrive</span>
                                          </div>
                                        </div>
                                      </div>
                                      {/* Karmically Aligned (9-10) */}
      ...
      <Dialog open={showImageConfirmation} onOpenChange={setShowImageConfirmation}>
        <DialogContent className="max-w-md mx-auto">
          <DialogHeader>
            ...
            <DialogDescription className="text-center text-black-600">
