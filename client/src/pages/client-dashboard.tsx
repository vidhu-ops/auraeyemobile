                    ...
                    <div className="bg-white rounded-lg p-4 border">
                      ...
                      {isLoadingHoroscope ? (
                        ...
                        <div className="space-y-4">
                          <div className="text-sm text-gray-600">{horoscope.content}</div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 pt-4 border-t">
                            <div className="text-center">
                              ...
                              <div className="flex justify-center">
                                {generateStarRating(horoscope.luckyStar?.love || 3)}
                              </div>
                            </div>
                            <div className="text-center">
                              <div className="text-xs text-gray-500 mb-1">Career</div>
                              <div className="flex justify-center">
                                {generateStarRating(horoscope.luckyStar?.career || 3)}
                              </div>
                            </div>
                            <div className="text-center">
                              <div className="text-xs text-gray-500 mb-1">Health</div>
                              <div className="flex justify-center">
                                {generateStarRating(horoscope.luckyStar?.health || 3)}
                              </div>
                            </div>
                          </div>
                        </div>
