      ...
      try {
        ...
        if (response.ok) {
          toast({
            ...
            description: "Your aura analysis report has been downloaded and sent to your email address.",
          });
        } else {
          toast({
            title: "PDF Downloaded",
            description: "PDF downloaded successfully. Email delivery failed - please check your email settings.",
          });
        }
      } catch (emailError) {
        ...
        toast({
          title: "PDF Downloaded",
          description: "PDF downloaded successfully. Email delivery failed - please try again later.",
        });
      }
