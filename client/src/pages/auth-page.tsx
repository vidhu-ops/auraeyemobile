...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col md:flex-row bg-gradient-to-br from-primary/5 to-secondary/5">
      <div className="relative w-full md:w-1/2 p-6 md:p-12 flex items-center justify-center">
        ...
        <Card className="w-full max-w-md z-10">
          <CardHeader>
            ...
            <CardTitle className="text-2xl">Welcome to Aurfy</CardTitle>
      ...
      <div className="w-full md:w-1/2 bg-gradient-to-br from-primary-dark to-dark text-white p-6 md:p-12 flex items-center">
        <div className="max-w-lg mx-auto">
          <h1 className="font-heading font-bold text-3xl md:text-4xl mb-6">Begin Your Spiritual Journey</h1>
          <p className="text-lg opacity-90 mb-8">
            Aurfy connects you with powerful spiritual tools to discover your aura, analyze your energy, and embark on a path of healing and self-discovery.
          </p>
