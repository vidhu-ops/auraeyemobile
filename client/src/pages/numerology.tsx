...
export default function NumerologyPage() {
  ...
  const generatePDF = () => {
    ...
    try {
      ...
      // Life Path Number
      addText(`Life Path Number: ${numerology.lifePathNumber}`, 12, true, [147, 51, 234]);
      ...
      addSection("CHAKRA-PLANET ANALYSIS");
      ...
      // Vibration Qualities
      addSection("VIBRATION QUALITIES");
      ...
      addText(personalYearInfo.title, 12, true, [99, 102, 241]);
      ...
      months.forEach(month => {
        ...
        addText(`${month.name} (Personal Month ${personalMonth})`, 10, true, [59, 130, 246]);
