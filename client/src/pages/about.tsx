          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
              <div>
                ...
                <p className="text-gray-600 mb-4">
                  By combining traditional metaphysical knowledge with cutting-edge cloud computing, we've created a platform that can analyze your energy field, provide personalized spiritual insights, and connect you with certified healers—all from the comfort of your home.
                </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="order-1 md:order-2">
                      ...
                      <ul className="space-y-2">
                        ...
                        <li className="flex items-start">
                          <Check className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                          <span> Verified and experienced energy healers with specific expertise
                          </span>
                        </li>
                        <li className="flex items-start">
                          <Check className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                          <span>Convenient scheduling for sessions from anywhere
                          </span>
                        </li>
                        <li className="flex items-start">
                          <Check className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                          <span>
                          Get complete clarity about your aura with digital reports and remedies</span>
                        </li>
                      </ul>
                    </div>
                  </div>
              ...
              <Card>
                <CardContent className="p-6 text-center">
                  <div className="w-24 h-24 rounded-full bg-gray-200 mx-auto mb-4 overflow-hidden">
                    <img 
                      src="file:///C:/Users/weewee/Downloads/WhatsApp%20Image%202025-08-11%20at%203.52.01%20AM.jpeg" 
                      alt="Nishant Sharma" 
