...
const DetailedAuraReadingCard = memo(function DetailedAuraReadingCard({ reading }: { reading: any }) {
  ...
  const generateComprehensivePDF = async (reading: any) => {
    ...
    try {
      ...
      pdf.setFontSize(8);
      pdf.text('Generated by AuraEye - Your Spiritual Wellness Platform   Page 1 of 8', 20, pageHeight - 10);
      ...
      if (reading.processedAuraImage || reading.imageUrl) {
        try {
          ...
          pdf.setFontSize(8);
          pdf.text('Generated by AuraEye - Your Spiritual Wellness Platform   Page 2 of 8', 20, pageHeight - 10);
