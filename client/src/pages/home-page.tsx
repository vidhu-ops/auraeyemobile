        ...
        <div className="container mx-auto px-4 py-16 relative z-10">
          <div className="flex flex-col items-center text-center">
            <div className="mb-8 animate-fade-in-down">
              <h1 className="font-Raleway font-bold text-5xl md:text-6xl lg:text-7xl mb-6 leading-tight text-white">
                Discover Your <span className="bg-gradient-to-r from-amber-300 to-blue-600 bg-clip-text text-transparent">Aura</span> <br />
                Embrace Your <span className="bg-gradient-to-r from-cyan-300 to-emerald-300 bg-clip-text text-transparent">Energy</span>
              </h1>
            </div>
