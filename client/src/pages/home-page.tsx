        ...
        <div className="mb-10">
          ...
          <div className="grid grid-cols-3 gap-3 max-w-xs mx-auto">
            <button 
              ...
              className="flex flex-col items-center justify-center rounded-xl bg-gradient-to-br from-purple-700/80 to-purple-200/80 hover:from-purple-400/90 hover:to-purple-600/90 transition-all shadow-lg p-3 border-2 border-purple-400/50"
              data-testid="button-scan-category"
            >
              <Scan className="h-5 w-5 text-purple-200 mb-1" />
              <span className="text-xs text-purple-100 font-bold uppercase">Scan</span>
            </button>
            
            <button 
              onClick={() => setActiveCategory('heal')}
              className="flex flex-col items-center justify-center rounded-xl bg-gradient-to-br from-green-900/80 to-green-700/80 hover:from-green-800/90 hover:to-green-600/90 transition-all shadow-lg p-3 border-2 border-green-400/50"
              data-testid="button-heal-category"
            >
              <Heart className="h-5 w-5 text-green-200 mb-1" />
              <span className="text-xs text-green-100 font-bold uppercase">Heal</span>
            </button>
            
            <button 
              onClick={() => setActiveCategory('connect')}
              className="flex flex-col items-center justify-center rounded-xl bg-gradient-to-br from-rose-900/80 to-rose-700/80 hover:from-rose-800/90 hover:to-rose-600/90 transition-all shadow-lg p-3 border-2 border-rose-400/50"
              data-testid="button-connect-category"
            >
              <Users className="h-5 w-5 text-rose-200 mb-1" />
              <span className="text-xs text-rose-100 font-bold uppercase">Connect</span>
            </button>
          </div>
        </div>
