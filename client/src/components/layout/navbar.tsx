...
export default function Navbar() {
  ...
  const settingsHref = isHealer ? '/healer-dashboard?tab=settings' : '/dashboard?tab=settings';
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2">
                          <div className="flex items-center space-x-1 bg-gradient-to-r from-purple-500 to-cyan-500 px-3 py-1.5 rounded-full">
                            ...
                            <span className={`text-white font-semibold text-sm ${credits < 0 ? "text-rose-100" : ""}`}>{credits}</span>
                          </div>
