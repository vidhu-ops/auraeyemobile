...
function calculateDominantSoulChakra(birthDate: string): number {
  ...
  // Object Analysis API endpoint (objects only, no humans) - DISABLED
  app.post("/api/analyze-object", (req, res) => {
    res.status(400).json({
      error: "Object Analysis Disabled",
      message: "Object analysis is currently disabled to prevent human image uploads. Please use Aura Analysis for scanning people.",
      requirements: [
