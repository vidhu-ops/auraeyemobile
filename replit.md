...
- **Image Size Validation**: All image uploads are limited to 3MB (3000KB) maximum. Files exceeding this limit are rejected with error message showing exact file size and requesting smaller image upload. Applied to all endpoints: aura analysis, object analysis, quick-vibe, and gemini-analyze.
